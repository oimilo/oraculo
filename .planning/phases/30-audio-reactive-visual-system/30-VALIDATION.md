...
| 30-02-01 | 02 | 2 | VIS-01 | integration | `npm test -- src/components/visuals/__tests__/EqualizerVisualizer.test.tsx` | ❌ W0 | ⬜ pending |
| 30-02-02 | 02 | 2 | VIS-04 | unit | `npm test -- src/components/visuals/__tests__/IdleAnimation.test.tsx` | ❌ W0 | ⬜ pending |
| 30-02-03 | 02 | 2 | VIS-03 | integration | `npm test -- src/components/visuals/__tests__/AudioReactiveBackground.test.tsx` | ❌ W0 | ⬜ pending |
...
- [ ] `src/components/visuals/__tests__/EqualizerVisualizer.test.tsx` — stubs for VIS-01
